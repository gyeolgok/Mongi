...
- 대본 사전검수, Emotion Previz 검수와 자산 사후검수 담당
- `APPROVED`, `REJECTED`, `BLOCKED` 판정 권한
- 감정 연기가 대본 의도와 Character Lock의 귀·꼬리·자세 규칙을 함께 따르는지 검사
...
- 승인된 대본을 시각 연기로 번역한 `emotion-previz.md` 작성
- `PREVIZ_APPROVED` 이후 컷·액션 프레임·말풍선·오디오·`edit.json` 제작
